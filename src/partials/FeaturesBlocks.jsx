      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Nosotros Brindamos</h2>
            <p className="text-xl text-gray-600">Brindamos características unicas para que uested tenga un viaje inolvidable!.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Mantas</h4>
              <p className="text-gray-600 text-center">Para el viaje, por que es frijido en todas las temporadas.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">GPS</h4>
              <p className="text-gray-600 text-center">Nuestros carros cuentan con GPS, para que no exedan la velocidad permitida.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Guias</h4>
              <p className="text-gray-600 text-center">Guias con especialidad en diferentes idiomas.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Salida inclusiva</h4>
              <p className="text-gray-600 text-center">Contamos con rampa en caso la persona sea discapacitada</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Todo en regla</h4>
              <p className="text-gray-600 text-center">Las personas y buses estan debidamente regladas.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Vista panoramica</h4>
              <p className="text-gray-600 text-center">Nuestos buses cuentan con vista panoramica.</p>
            </div>
